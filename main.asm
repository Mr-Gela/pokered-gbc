...
IF GEN_2_GRAPHICS
RedPicFront:: INCBIN "pic/ztrainer/red.pic"
rept 11 ; Padding
	db 0
endr
ELSE
...
RedPicBack:         INCBIN "pic/ztrainer/redb.pic"
...
; New
RivalAPic:       	    INCBIN "pic/ztrainer/rivala.pic"
RivalBPic:      	    INCBIN "pic/ztrainer/rivalb.pic"
LeafPicFront::		    INCBIN "pic/ztrainer/leaf.pic"
LeafPicBack:: 			INCBIN "pic/ztrainer/leafb.pic"
